...
public final class KafkaTopics {
    ...
    public static final String CANCEL_ORDER_COMMAND ="cancel-order-command";
    ...
    public static final String RELEASE_INVENTORY_COMMAND ="release-inventory-command";
    public static final String INVENTORY_RESERVATION_FAILED = "inventory-reservation-failed";
    public static final String PAYMENT_COMPLETED = "payment-completed";
    public static final String PAYMENT_FAILED = "payment-failed";
    public static final String PROCESS_PAYMENT_COMMAND ="process-payment-command";
    public static final String DELIVERY_STATUS_UPDATED = "delivery-status-updated";
    public static final String CREATE_DELIVERY_COMMAND ="create-delivery-command";
    public static final String DELIVERY_ASSIGNED ="delivery-assigned";
    public static final String DELIVERY_ASSIGNMENT_FAILED ="delivery-assignment-failed";
